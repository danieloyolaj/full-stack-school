      ...
      <div className="w-full xl:w-1/3 flex flex-col gap-4">
        <div className="bg-white p-4 rounded-md">
          ...
          <div className="mt-4 flex gap-4 flex-wrap text-xs text-gray-500">
            <Link href={`/list/classes?supervisorId=${"teacher2"}`} className="p-3 rounded-md bg-lamaSky">Teacher&apos;s Classes</Link>
            ...
            <Link href={`/list/exams?teacherId=${"teacher2"}`} className="p-3 rounded-md bg-lamaSkyLight">Teacher&apos;s Exams</Link>
